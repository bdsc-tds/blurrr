...
setMethod(
  "assign2template",
  c("Blurrr", "numeric", "logical", "logical"),
  function(x, cores, force, verbose) {
    if (!is.null(get_xnCell(x))) {
      ...
      x@assignedXnCell <- .assign2template(
...
setMethod(
  "assign2template",
  c("Blurrr", "numeric", "missing", "missing"),
...
setMethod(
  "assign2template",
  c("Blurrr", "numeric", "logical", "missing"),
...
setMethod(
  "assign2template",
  c("Blurrr", "numeric", "missing", "logical"),
...
setMethod(
  "subset2assigned",
  c("Blurrr", "character", "character", "numeric"),
  function(
    x,
    mole = c("cell", "trans"),
...
setMethod(
  "subset2assigned",
  c("Blurrr", "character", "missing", "missing"),
  function(
    x,
    mole = c("cell", "trans"),
    level = "spot",
...
setMethod(
  "plot_mole",
  c("Blurrr", "character", "character", "character", "numeric", "character"),
  function(
    x,
    mole = c("cell", "trans"),
...
setMethod(
  "plot_mole",
  c("Blurrr", "character", "character", "missing", "missing", "character"),
  function(
    x,
    mole = c("cell", "trans"),
    mode = c("raw", "assigned", "both"),
...
setMethod(
  "save2disk",
  c("Blurrr", "character", "numeric", "logical", "logical"),
...
setMethod(
  "save2disk",
  c("Blurrr", "character", "numeric", "logical", "missing"),
...
setMethod(
  "save2disk",
  c("Blurrr", "character", "numeric", "missing", "missing"),
...
setMethod(
  "save2disk",
  c("Blurrr", "character", "missing", "logical", "missing"),
...
setMethod(
  "save2disk",
  c("Blurrr", "character", "missing", "missing", "missing"),
...
setMethod(
  "save2disk",
  c("Blurrr", "character", "missing", "logical", "numeric"),
...
setMethod(
  "save2disk",
  c("Blurrr", "character", "missing", "missing", "numeric"),
